...
export default function UpdateProduk(product) {
    ...
    async function handleUpdate(e){
        e.preventDefault();
        setIsMutating(true)
        await fetch (`https://64a7c8a4dca581464b84c5b0.mockapi.io/Products/${product.id}` , {
            method: "Patch",
            headers: {
                ...
                <form onSubmit={handleUpdate}>
                    ...
                    <div className="modal-action">
                        ...
                        {!isMutating ? (
                            ...
                            <button type="button" className="btn btn-loading" onClick={handleChange}> Updating ...</button>
                        )}
                    </div>
                </form>
